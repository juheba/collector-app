...
class CollectionApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [CollectionResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CollectionResponse>> createCollection({
    ...
    try {
      ...
      _bodyData = createCollectionRequest == null
          ? null
          : _serializers.serialize(createCollectionRequest,
              specifiedType: _type);
    ...
    CollectionResponse? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(CollectionResponse),
  ...
  ///
  /// Parameters:
  /// * [collectionId] - ID of the collection which will be deleted.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<void>> deleteCollection({
    ...
    final _path = r'/collections/{collectionId}'.replaceAll(
        '{' r'collectionId' '}',
  ...
  /// Returns a [Future] containing a [Response] with a [CollectionResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CollectionResponse>> getCollection({
    required String collectionId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [CollectionItemsResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CollectionItemsResponse>> getCollectionItems({
    required String collectionId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    CollectionItemsResponse? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(CollectionItemsResponse),
    ...
    return Response<CollectionItemsResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CollectionsResponse>> getCollections({
    num? limit,
    String? nextKey,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
  ...
  ///
  /// Parameters:
  /// * [collectionId] - ID of the collection which will receive the update.
  ...
  /// Returns a [Future] containing a [Response] with a [CollectionResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CollectionResponse>> updateCollection({
    required String collectionId,
    ...
    try {
      ...
      _bodyData = updateCollectionRequest == null
          ? null
          : _serializers.serialize(updateCollectionRequest,
              specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
  ...
  ///
  /// Parameters:
  /// * [collectionId] - ID of the collection which will receive the items.
  /// * [updateCollectionItemsRequest] - Items to add to the collection.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> updateCollectionItems({
    required String collectionId,
