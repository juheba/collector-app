...
class _$ItemResponse extends ItemResponse {
  ...
  _$ItemResponse._({required this.item}) : super._() {
    BuiltValueNullFieldError.checkNotNull(item, r'ItemResponse', 'item');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'ItemResponse')..add('item', item))
        .toString();
  }
}
...
class ItemResponseBuilder
  ...
  _$ItemResponse _build() {
    ...
    try {
      _$result = _$v ?? new _$ItemResponse._(item: item.build());
    } catch (_) {
